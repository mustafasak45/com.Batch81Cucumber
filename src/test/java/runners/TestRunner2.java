...
//        plugin={"html:target/cucumber-reports.html"}, //rapor yazdırma istenildiginde kullanılır. target packagesinin altında olur
        ...
        plugin={"html:target/cucumber-reports2.html",     // yukrıdaki kodun aynısı
                "json:target/json-reports/cucumber2.json",//Belirtilen adresde package de json raporu oluşturulur. CTRL+ALT+L ile kodları hizala
                "junit:target/xml-report/cucumber2.xml" },    //Belirtilen adrese xml formatın rapor verir
